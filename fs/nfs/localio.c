...
static void nfs_local_read_aio_complete(struct kiocb *kiocb, long ret, long ret2)
{
	struct nfs_local_kiocb *iocb =
...
static void nfs_local_write_aio_complete(struct kiocb *kiocb, long ret, long ret2)
{
	struct nfs_local_kiocb *iocb =
		container_of(kiocb, struct nfs_local_kiocb, kiocb);
